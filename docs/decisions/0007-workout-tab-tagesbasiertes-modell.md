...
- Kein Weg, ein komplettes Tages-Workout zu löschen (nur einzelne Sätze oder das Entfernen der Routine) – in diesem Umsetzungsschritt nicht vorgesehen, da nicht Teil des Auftrags. **Nachtrag (2026-09-09):** Einzelne, noch unbegonnene Übungen lassen sich inzwischen gezielt aus dem Tages-Roster entfernen (`removeExerciseFromWorkout()`, "⋮"-Menü auf der Roster-Karte im Workout-Tab) – folgt derselben Schutzregel wie jede andere Kaskade hier (nur unbegonnene Einträge, `startedAt === null`). Ein komplettes Tages-Workout löschen bleibt weiterhin nicht möglich
