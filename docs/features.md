...
Reiner Platzhalter ohne Inhalt/Funktion — ersetzt seit [ADR 0018](decisions/0018-uebungen-tab-entfernt.md) den bisherigen eigenständigen Übungen-Tab an derselben Position in der Bottom-Nav. Übungen anlegen/bearbeiten/löschen läuft seitdem ausschließlich über das Workout-Tab (Neue-Übung-Sheet bzw. Übungs-Detail-Sheet, s. oben) und perspektivisch über die noch zu bauende Übungs-Verwaltung innerhalb der Routinen (s. "Vorgemerkte, noch nicht spezifizierte Erweiterungen"). Nicht zu verwechseln mit dem gleichnamigen, ebenfalls noch leeren "Statistik"-Reiter auf der Übungs-Detailseite (Segmented Control, s. oben) — zwei unabhängige Platzhalter, die künftig unterschiedliche Inhalte bekommen (dieser Tab übergreifend, der Reiter je Übung).
