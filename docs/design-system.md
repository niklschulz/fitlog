...
- **`gap-6` zwischen den Wochenblöcken** als Orientierungshilfe zwischen Sonntag und Montag — sichtbar, während man zwischen zwei Wochen swipt, im eingerasteten Ruhezustand naturgemäß nicht (dann ist nur eine volle Woche im Bild)
